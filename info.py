...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002290874216').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '1002432955970') # give your force subscribe channel id here else leave it blank
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', '@HEANTA') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
